...
ifeq "$(CFG)" "Debug"
OUTDIR=Debug
OUTFILE=$(OUTDIR)/omp_pi_nofalse.exe
CFG_INC=
CFG_LIB=
CFG_OBJ=
COMMON_OBJ=$(OUTDIR)/omp_pi_nofalse.o 
OBJ=$(COMMON_OBJ) $(CFG_OBJ)
ALL_OBJ=$(OUTDIR)/omp_pi_nofalse.o 

COMPILE=g++ -c   -g -fopenmp -o "$(OUTDIR)/$(*F).o" $(CFG_INC) $<
LINK=g++  -g -fopenmp -o "$(OUTFILE)" $(ALL_OBJ)
