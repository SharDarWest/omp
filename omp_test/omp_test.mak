...
ifeq "$(CFG)" "Debug"
OUTDIR=Debug
OUTFILE=$(OUTDIR)/omp_test.exe
CFG_INC=
CFG_LIB=
CFG_OBJ=
COMMON_OBJ=$(OUTDIR)/omp_test.o 
OBJ=$(COMMON_OBJ) $(CFG_OBJ)
ALL_OBJ=$(OUTDIR)/omp_test.o 

COMPILE=g++ -c  -v  -g -fopenmp  -o "$(OUTDIR)/$(*F).o" $(CFG_INC) $<
LINK=g++  -v -g -fopenmp -o "$(OUTFILE)" $(ALL_OBJ)
...
COMPILE=g++ -c  -v  -fopenmp -o "$(OUTDIR)/$(*F).o" $(CFG_INC) $<
LINK=g++  -v -o "$(OUTFILE)" $(ALL_OBJ)
